...
/* harmony import */ var _modules_anchor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/anchor */ "./js/modules/anchor.js");
/* harmony import */ var _modules_validation__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/validation */ "./js/modules/validation.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_map__WEBPACK_IMPORTED_MODULE_2__["addMap"])();
  Object(_modules_menu__WEBPACK_IMPORTED_MODULE_3__["clickOnToggle"])();
  Object(_modules_menu__WEBPACK_IMPORTED_MODULE_3__["clickOnDocument"])();
  Object(_modules_menu__WEBPACK_IMPORTED_MODULE_3__["clickOnLinks"])();
  Object(_modules_anchor__WEBPACK_IMPORTED_MODULE_4__["onLinkMove"])();
  Object(_modules_validation__WEBPACK_IMPORTED_MODULE_5__["validateForm"])();
...
/*!******************************!*\
  !*** ./js/modules/anchor.js ***!
  \******************************/
/*! exports provided: onLinkMove */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onLinkMove", function() { return onLinkMove; });
...
/*!***************************!*\
  !*** ./js/modules/map.js ***!
  \***************************/
/*! exports provided: addMap */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addMap", function() { return addMap; });
var mapImage = document.querySelector('[data-map-nojs]');
var mapYandex = document.querySelector('[data-map-yandex]');
function addMap() {
...
/*!****************************!*\
  !*** ./js/modules/menu.js ***!
  \****************************/
/*! exports provided: clickOnToggle, clickOnDocument, clickOnLinks */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "clickOnToggle", function() { return clickOnToggle; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "clickOnDocument", function() { return clickOnDocument; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "clickOnLinks", function() { return clickOnLinks; });
function _createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it.return != null) it.return(); } finally { if (didErr) throw err; } } }; }
function _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }
function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }
var header = document.querySelector('[data-header]');
var toggleNav = document.querySelector('[data-nav-toggle]');
...
function clickOnLinks() {
  var _iterator = _createForOfIteratorHelper(headerLinks),
    _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
...
var bookingForm = document.querySelector('[data-form]');
...
function inputCheck(elem) {
  ...
  var inputReg = elem.getAttribute('data-reg');
  var reg = new RegExp(inputReg);
...
function buttonHandler(evt) {
  checkEmptyInputs();
  var allValid = [];
  validFormArray.forEach(function (elem) {
    allValid.push(elem.getAttribute('is-valid'));
  });
  var isAllValid = allValid.reduce(function (acc, current) {
